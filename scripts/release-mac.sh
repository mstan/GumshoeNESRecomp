...
REPO_NAME="GumshoeNESRecomp"      # GitHub repo / zip basename
APP_NAME="Gumshoe"        # .app display name (may contain spaces)
TARGET="GumshoeRecomp"            # cmake target == built binary filename in build-mac/
SYSTEM="nes"            # nes | snes | genesis | vb | psx
VERSION="v1.2-macos"          # release tag, e.g. v0.1.0-macos
ROM_HINT="Gumshoe (USA) .nes dump"        # human description of the ROM the user must supply
# ==============================================
